  ...
  return (
    <div className="space-y-8 pb-20">
        ...
        <div>
          ...
          {projects.length === 0 && (
            <p className="text-sm text-slate-500 mt-1.5">
              No projects yet.{" "}
              <a href="/site-reports/projects" className="text-emerald-400 underline">Create one first.</a>
            </p>
          )}
        </div>
      ...
      <div className="space-y-4">
        ...
        {recommendations.length > 0 && projectId && (
          <p className="text-xs text-slate-500 text-center">
            <a href={`/site-reports/public`} className="text-emerald-400 hover:text-emerald-300 underline">
      ...
      <div className="space-y-4">
        ...
        {risks.length > 0 && (
          <p className="text-xs text-slate-500 text-center">
            <a href="/site-reports" className="text-emerald-400 hover:text-emerald-300 underline">
              See all risks →
            </a>
          </p>
        )}
